            ...
            return (
                <>
                    ...
                    <MainLayout user={user} title="Users - JUAPOS" page="Users" breadcrumb={breadcrumb}>
                                                        ...
                                                        <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100" key={value.email}>
                                                            ...
                                                            <td className="text-sm text-gray-900 font-light  whitespace-nowrap">
                                                                <div className="flex items-center space-x-4 text-sm">
                                                                    ...
                                                                    <button  onClick={() =>{setShowModal(true);setSelectEmail(value.email)}}  className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
                                                                    <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        >
                            you will delete account with email {selectEmail}
                        </ModalDelete>
