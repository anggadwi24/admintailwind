                ...
                <>
                    ...
                    <MainLayout user={user} title="Users - JUAPOS" page="Users" subpage="">
                        <div className='flex justify-between mb-4'>
                            ...
                            <h4 className="mb-4 mt-3 text-lg font-semibold text-gray-600 dark:text-gray-300">
                            Data Users
                            </h4>
                                                        ...
                                                        <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100" key={value.email}>
                                                            ...
                                                            <td className="text-sm text-gray-900 font-light  whitespace-nowrap">
                                                                <div className="flex items-center space-x-4 text-sm">
                                                                    <Link href={{ pathname: '/users/edit', query: { email: value.email } }} className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
